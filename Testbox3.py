...
with PIconnect.PIAFDatabase(
    ...
    condensed = condensed[c.str.contains(r"090_R\d{3}", regex=True)]
    print(condensed['Referencondensed['Referenced_el [UnitProcedure](0)']ed_el [UnitProcedure](0)'].unique())
    
    for tag in ['ST01']:
        #Populate tag column
        condensed['Tag'] = '100090' + condensed['Referenced_el [UnitProcedure](0)'].str.extract(pat=r'(R\d{3})') + tag
